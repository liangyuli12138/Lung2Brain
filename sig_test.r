...
# dir.create(paste0("/public/workspace/lily/Lung2Brain/version_4_27/sig_test/",name))  # 2021-4-30 change this code 
respath <- paste0("/public/workspace/lily/Lung2Brain/Version5/Fig2/",name,"/") # 2021-4-30 change this code 
...
gse68645_mod <- as.data.frame(gse68645_mod)

res.gse68465 <- merge(gse68465_mod,info,by="row.names")
